<template>
  <div class="min-h-screen bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 text-slate-900 dark:text-white">
    <!-- Navigation Bar -->
    <nav class="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-16 sm:py-24">
      <div class="text-center space-y-6">
        <h1 class="text-5xl sm:text-6xl font-bold text-slate-900 dark:text-white">
          Bienvenue sur
          <span class="bg-gradient-to-r from-blue-600 dark:from-blue-400 to-blue-600 dark:to-cyan-400 bg-clip-text text-transparent">
            Decisional Client
          </span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Feature 1 -->
        <Card class="border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 backdrop-blur-sm">
          <CardHeader>
            <div class="flex items-center gap-3 mb-2">
              <div class="p-2 bg-blue-100 dark:bg-blue-500/20 rounded-lg">
                <Icon name="lucide:lock" class="h-6 w-6 text-blue-600 dark:text-blue-400" />
              </div>
              <CardTitle class="text-slate-900 dark:text-white">Authentification Sécurisée</CardTitle>
            </div>
          ...
          <CardHeader>
            <div class="flex items-center gap-3 mb-2">
              <div class="p-2 bg-green-100 dark:bg-green-500/20 rounded-lg">
                <Icon name="lucide:palette" class="h-6 w-6 text-green-600 dark:text-green-400" />
              </div>
              <CardTitle class="text-slate-900 dark:text-white">Interface Reka UI</CardTitle>
            </div>
            <CardDescription class="text-slate-600 dark:text-slate-400">
          ...
          <CardHeader>
            <div class="flex items-center gap-3 mb-2">
              <div class="p-2 bg-purple-100 dark:bg-purple-500/20 rounded-lg">
                <Icon name="lucide:gauge" class="h-6 w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <CardTitle class="text-slate-900 dark:text-white">Tableau de Bord Admin</CardTitle>
            </div>
            <CardDescription class="text-slate-600 dark:text-slate-400">
    ...
    <div v-if="user" class="max-w-7xl mx-auto px-4 py-12">
      <Card class="border-slate-200 dark:border-slate-700 bg-gradient-to-r from-green-50 dark:from-green-500/10 to-emerald-50 dark:to-emerald-500/10 backdrop-blur-sm">
        <CardHeader>
          <CardTitle class="text-slate-900 dark:text-white flex items-center gap-2">
            <Icon name="lucide:check-circle-2" class="h-6 w-6 text-green-600 dark:text-green-400" />
            Vous êtes connecté
          </CardTitle>
        </CardHeader>
